# USE CASE 13: Top N populated cities in a continent
## CHARACTERISTIC INFORMATION
### Goal in context
Display the top N populated cities within a selected continent ordered from largest to smallest so that users can analyse and compare the most populated cities across that continent.
### Scope
...
### Success Condition
- The system displays the top N cities within the selected continent ordered by population (largest to smallest).
...
- Research Analyst
### Trigger
The user selects “Top N Cities by Continent” and specifies both the continent name and number of cities (N).
## MAIN SUCCESS SCENARIO
1. User launches the application.
2. User selects “Top N Cities by Continent.”
3. System prompts the user to enter a continent name and number of cities (N).
4. User provides valid inputs (e.g., Continent = Asia, N = 10).
5. System connects to the world database.
6. System executes the SQL query to retrieve the top N cities within the selected continent ordered by population.
7. System formats the retrieved data into a readable table or report.
8. System displays the top N cities in the selected continent.
9. User reviews and confirms the report successfully.
## EXTENSION
3. **User does not enter continent name or N value**:
