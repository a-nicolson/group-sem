# USE CASE 04: Top N populated countries in the world
## CHARACTERISTIC INFORMATION
### Goal in context
Display the top N populated countries in the world ordered from largest to smallest so that users can quickly identify the most populated countries globally.
### Scope
...
- The user provides a valid positive integer value for arN.
### Success Condition
- The system displays the top N countries ordered by population (largest to smallest).
...
- Research Analyst
### Trigger
The user selects “Top N Countries Report” and specifies the number of countries (N).
## MAIN SUCCESS SCENARIO
1. User launches the application.
2. User selects “Top N Countries Report.”
3. System prompts the user to enter the number of countries (N).
4. User provides a valid positive integer (e.g., 10).
5. System connects to the world database.
6. System executes the SQL query to retrieve the top N countries ordered by population.
7. System formats the retrieved data into a readable table or report.
8. System displays the top N countries by population.
